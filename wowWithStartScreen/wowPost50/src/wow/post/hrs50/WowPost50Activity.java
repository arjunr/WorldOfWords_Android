...
public class WowPost50Activity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        newGenerateButton generatebutton=new newGenerateButton(word);
        Log.d("arjun", "Button Has been gen");
        //buttonOriginal[0]=new Button(getApplicationContext());
        ...
        poss=wordClass.possibilities.toArray(new String[wordClass.possibilities.size()]);
        Arrays.sort(poss);
	...
	private Runnable mMyRunnable = new Runnable()
	{
		...
		public void onBackPressed() {
			Intent intent=new Intent(WowPost50Activity.this,StartScreen.class);
			startActivity(intent);
		...
		@Override
		    protected void onStart() {
		        super.onStart();
		        words = new ArrayList<String>(wordClass.possibilities);
		        Log.d("test", "onStart");
	...
	class temp implements Runnable {
		...
		public void run() {
	        // compute primes larger than minPrime
	    	    ...
	    	    wordClass.word=gen.wordGenerator(myContext);
	    	    Log.d("test", "Inside Thread "+wordClass.word);
